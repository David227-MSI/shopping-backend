...
// LocalDate startDate = LocalDate.parse(reportMonth + "-01",
...
// orderItemRepository.findByOrderIdIn(paidOrderIds);
...
// Integer maxVersion =
// salesReportRepository.findMaxVersionByMonth(reportMonth);
...
// .averagePrice(agg.totalAmount.divide(BigDecimal.valueOf(agg.quantitySold), 2,
...
// return
// salesReportRepository.findByReportMonthOrderByVersionDesc(reportMonth);
// }

// public byte[] exportToExcel(String reportMonth, Integer version) {
// List<SalesReport> reports = salesReportRepository
// .findByReportMonthAndVersionOrderByBrandNameAscProductNameAsc(reportMonth,
// version);
...
// public byte[] exportToExcelByBrand(String reportMonth, Integer version,
// Integer brandId) {
// List<SalesReport> reports = salesReportRepository
// .findByReportMonthAndVersionAndBrandIdOrderByProductNameAsc(reportMonth,
// version, brandId);
// if (reports.isEmpty()) return null;
...
// return
// salesReportRepository.findByBrandIdOrderByReportMonthDescVersionDesc(brandId);
// }
...
// return
// salesReportRepository.findByReportMonthAndVersionOrderByBrandNameAscProductNameAsc(reportMonth,
// maxVersion);
// }
...
// // return
// salesReportRepository.findDistinctBrandIdsByReportMonth(reportMonth); // 需要在
// SalesReportRepository 中新增
